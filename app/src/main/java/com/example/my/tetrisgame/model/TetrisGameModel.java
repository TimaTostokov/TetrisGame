...
import com.example.my.tetrisgame.presenter.GameModel;
import com.example.my.tetrisgame.presenter.GameTurn;
import com.example.my.tetrisgame.presenter.Point;
import com.example.my.tetrisgame.presenter.PointType;
import com.example.my.tetrisgame.presenter.PresenterCompletableObserver;
import com.example.my.tetrisgame.presenter.PresenterObserver;
    ...
    public boolean rotatePoints(int x, int y, int size) {
        ...
        for (int i = 0; i < size; i++) {
            for (int j = 0; j < size; j++) {
                ...
                if (point.isStablePoint() && Objects.requireNonNull(getPlayingPoint(x + size - 1 - i, y + j)).isFallingPoint) {
                    canRotate = false;
                    break;
                }
